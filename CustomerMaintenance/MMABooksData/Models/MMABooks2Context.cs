...
{
    public partial class MMABooks2Context : DbContext
    {
        public MMABooks2Context()
        {
        }

        public MMABooks2Context(DbContextOptions<MMABooks2Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(ConfigurationManager.ConnectionStrings["MMABooksConnection"].ConnectionString).
